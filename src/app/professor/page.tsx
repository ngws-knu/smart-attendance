    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-sky-100 via-indigo-100 to-emerald-50">
            ...
            <button
                ...
                className="px-10 py-4 text-lg rounded-full font-semibold border-2 border-yellow-400 bg-white/80 text-yellow-700 shadow-md backdrop-blur-sm transition-all duration-150 hover:bg-yellow-100 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-yellow-300"
            >
                Start Attendance
            </button>
        </div>
